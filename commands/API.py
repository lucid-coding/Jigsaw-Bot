...
class catties(commands.Cog):
    ...
    @commands.command()
    async def kiss(self, ctx, member: disnake.Member) -> str:
        async with aiohttp.ClientSession() as session:
    ...
    @commands.command()
    async def gay(self, ctx, member: disnake.Member = None) -> None:
    ...
    @commands.command()
    async def pp(self, ctx, member: disnake.Member = None) -> None:
        member = member or ctx.author
    ...
    @commands.command()
    async def hug(self, ctx, member: disnake.Member) -> str:
        async with aiohttp.ClientSession() as session:
            async with session.get(
    ...
    @commands.command()
    async def cuddle(self, ctx, member: disnake.Member) -> str:
        async with aiohttp.ClientSession() as session:
            async with session.get(
    ...
    @commands.command()
    async def slap(self, ctx, member: disnake.Member) -> str:
        async with aiohttp.ClientSession() as session:
            async with session.get(
    ...
    @commands.command()
    async def pat(self, ctx, member: disnake.Member) -> str:
        async with aiohttp.ClientSession() as session:
            async with session.get(
    ...
    @commands.command()
    async def kill(self, ctx, member: disnake.Member) -> str:
        async with aiohttp.ClientSession() as session:
            async with session.get(
